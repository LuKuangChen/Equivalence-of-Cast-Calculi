module CastRepresentations.LazyUDHypercoercions3 (Label : Set) where
{-
...
This property has a benefit that applying identity casts, which happens
a lot in the framework, always take constant time. Another benefit is
that the space consumption of an identity cast is also a constant.
-}
...
lem-expand-inj l (S ⇒ T)
  rewrite
    lem-rewrite-proj l S
  | lem-rewrite-inj l T
  | identity-mʳ (mk⇒ ⌈ * ⟹[ l ] S ⌉ ⌈ T ⟹[ l ] * ⌉)
  = refl
lem-expand-inj l (S ⊗ T)
  rewrite
    lem-rewrite-inj l S
