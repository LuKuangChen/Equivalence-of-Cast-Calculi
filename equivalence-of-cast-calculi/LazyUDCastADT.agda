module equivalence-of-cast-calculi.LazyUDCastADT
  (Label : Set)
  where
...
open import equivalence-of-cast-calculi.C.BlameStrategies Label using (LazyUDBS)
open import equivalence-of-cast-calculi.C.Machine Label LazyUDBS
  using ()
