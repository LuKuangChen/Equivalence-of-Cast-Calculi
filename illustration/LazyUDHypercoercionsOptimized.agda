module illustration.LazyUDHypercoercionsOptimized
  (Label : Set)
  where
{-
...
⇑ l *     = *
⇑ l (` B)     = ↷ ε (` ε) (‼ `B)
⇑ l (` S ⇒ T) = ↷ ε (` (mk⇒ (⇓ (neg l) S) (⇑ l T))) (‼ `⇒)
⇑ l (` S ⊗ T) = ↷ ε (` (mk⊗ (⇑ l S) (⇑ l T))) (‼ `⊗)


⇓ l *     = *
⇓ l (` B)     = ↷ (⁇ `B l) (` ε)               ε
⇓ l (` S ⇒ T) = ↷ (⁇ `⇒ l) (` (mk⇒ (⇑ (neg l) S) (⇓ l T))) ε
...
lem-expand-inj l (S ⇒ T)
  rewrite
    lem-rewrite-proj (neg l) S
  | lem-rewrite-inj l T
  | identity-mʳ (mk⇒ ⌈ * ⟹[ neg l ] S ⌉ ⌈ T ⟹[ l ] * ⌉)
  = refl
lem-expand-inj l (S ⊗ T)
  rewrite
    lem-rewrite-inj l S
